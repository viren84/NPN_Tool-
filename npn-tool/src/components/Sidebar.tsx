    ...
    <aside className="w-64 bg-white border-r border-gray-200 flex flex-col h-screen fixed left-0 top-0">
      <div className="p-6 border-b border-gray-100">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-lg bg-red-600 flex items-center justify-center">
            <span className="text-white font-bold text-sm">NPN</span>
          </div>
          <div>
            <h1 className="font-bold text-gray-900 text-sm">NPN Filing Tool</h1>
            <p className="text-xs text-gray-500">Health Canada</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-gray-100">
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={toggle}
            className="text-xs text-gray-400 hover:text-yellow-500 p-1"
